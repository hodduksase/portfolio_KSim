...
# -*- coding: utf-8 -*-
"""
데이터 분석 포트폴리오 PowerPoint 생성 스크립트
심기열 - 데이터 분석가 포트폴리오
"""
...
def main():
    """메인 실행 함수"""
    print("🚀 데이터 분석 포트폴리오 PowerPoint 생성 시작")
